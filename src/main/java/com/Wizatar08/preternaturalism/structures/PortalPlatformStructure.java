package com.Wizatar08.preternaturalism.structures;
...
public class PortalPlatformStructure extends Structure<NoFeatureConfig> {
    public PortalPlatformStructure(Codec<NoFeatureConfig> codec) {
        super(codec);
    }

    @Override
    public  IStartFactory<NoFeatureConfig> getStartFactory() {
        return PortalPlatformStructure.Start::new;
    }
        ...
        public void func_230364_a_(DynamicRegistries dynamicRegistryManager, ChunkGenerator chunkGenerator, TemplateManager templateManagerIn, int chunkX, int chunkZ, Biome biomeIn, NoFeatureConfig config) {
            ...
            JigsawManager.func_242837_a(
                    ...
                    new VillageConfig(() -> dynamicRegistryManager.getRegistry(Registry.JIGSAW_POOL_KEY)
                            .getOrDefault(new ResourceLocation(Preternaturalism.MOD_ID, "portal_platform_start")), 7 /*Size of jigsaw*/),
                    AbstractVillagePiece::new, chunkGenerator, templateManagerIn,
            ...
            // This shows where a structure is:
            //Preternaturalism.LOGGER.log(Level.DEBUG, "Rundown House at " +
