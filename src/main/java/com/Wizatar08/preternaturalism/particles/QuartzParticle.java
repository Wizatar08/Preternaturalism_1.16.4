package com.inf1n1T388.preternaturalism.particles;

import java.util.Locale;

import com.mojang.brigadier.StringReader;
import com.mojang.brigadier.exceptions.CommandSyntaxException;
import com.inf1n1T388.preternaturalism.init.ParticleInit;
...
public class QuartzParticle extends SpriteTexturedParticle {

    private double posX, posY, posZ;

    public QuartzParticle(ClientWorld worldIn, double xCoordIn, double yCoordIn, double zCoordIn, double xSpeedIn,
        ...
        this.maxAge = (int) (Math.random() * 10.0d) + 100;
    }
    ...
    public static class Factory implements IParticleFactory<ColouredParticleData> {
        ...
        @Nullable
        @Override
        public Particle makeParticle(ColouredParticleData typeIn, ClientWorld worldIn, double x, double y, double z, double xSpeed, double ySpeed, double zSpeed) {
            QuartzParticle particle = new QuartzParticle(worldIn, x, y, z, xSpeed, ySpeed, zSpeed, typeIn,
                    spriteSet);
    ...
    public static class ColouredParticleData implements IParticleData {
        ...
        public ParticleType<ColouredParticleData> getType() {
            return null;// ParticleInit.QUARTZ_PARTICLE.get();
        }
