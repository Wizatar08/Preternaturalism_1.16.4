...
public class ItemInit {
    ...
    public static final RegistryObject<Item> DRAGON_ESSENCE_TITANIUM_PLATED_CONTAINER = ITEMS.register ("dragon_essence_filled_titanium_plated_container", () ->  new DragonEssenceTitaniumPlatedContainer("Dragon Essence", new Item.Properties().group(Preternaturalism.PreternaturalismItemGroup.instance).maxStackSize(1)));
